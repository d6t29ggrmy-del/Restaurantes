...
def main():
    ...
    # "alertaveis": entre os novos, so os recem-abertos (poucas avaliacoes) E
    # bem avaliados (nota >= 4 ou ainda sem nota)
    alertaveis = [p for p in novos if poucas_avaliacoes(p) and nota_ok(p)]
